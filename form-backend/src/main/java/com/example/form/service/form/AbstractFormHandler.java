...
public abstract class AbstractFormHandler implements FormHandler {
    protected AbstractFormHandler(FormFieldService formFieldService, List<FormFieldChecker> formFieldCheckers) {
    ...
    public void checkField(List<FormField> formFields, List<FormFieldData> formData) {
    ...
    public SubmitFormDataVo submit(List<FormFieldData> formData, Form form) {
        ...
        List<FormField> formFields = formFieldService.getFormFields(form.getId());
        // 检查字段类型
     ...
     * @return
     */
    protected List<FormFieldData> autoCalculate(List<FormField> formFields, List<FormFieldData> formData) {
        return formData;
    }
     ...
     * @return
     */
    protected abstract SubmitFormDataVo responseWrapper(Form form, List<FormField> formFields, List<FormFieldData> formData);
}
